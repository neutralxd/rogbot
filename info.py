...
API_ID = int(environ.get('API_ID', '29222575'))
API_HASH = environ.get('API_HASH', 'ea482a2192cde926cc15f1d6272e803a')
BOT_TOKEN = environ.get('BOT_TOKEN', "7140621895:AAGSU5RThJQxRGPPYxxb9lXicGYOqMaei5w")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002227639397'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5461422291').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002227639397').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5461422291').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ahighrisk:BThvPlzx9gXJ1zDB@cluster0.twje1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "ahighrisk")
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'robotlinksz') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
